...
export const mockCommissions: Commission[] = [
  {
    ...
    basis_amount: null,
    currency: "GHS",
    service_name: "Basic website",
    recurring: false,
    rule_version: "2026-08-gh-v2",
    status: "paid",
  ...
  },
  {
    ...
    basis_amount: 1200,
    currency: "GHS",
    service_name: "SEO and monthly maintenance",
    recurring: true,
    rule_version: "2026-08-gh-v2",
    status: "approved",
    eligible_at: daysAgo(1),
...
export const mockLeaderboard: LeaderboardEntry[] = [
  { rank: 1, display_name: "Ozzy Referrer", qualified_leads: 8, won_referrals: 3, total_payout: 7500, currency: "GHS" },
  { rank: 2, display_name: "Sarah K.", qualified_leads: 5, won_referrals: 2, total_payout: 5000, currency: "GHS" },
  { rank: 3, display_name: "Marcus T.", qualified_leads: 4, won_referrals: 1, total_payout: 2500, currency: "GHS" },
  { rank: 4, display_name: "Linda M.", qualified_leads: 3, won_referrals: 1, total_payout: 2500, currency: "GHS" },
  { rank: 5, display_name: "David R.", qualified_leads: 2, won_referrals: 0, total_payout: 0, currency: "GHS" },
];
